                ...
                <div class="col mainbg">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <input type="text" class="form-control" aria-describedby="name" placeholder="Imię">
                        </div>

                        <div class="form-group d-flex justify-content-center">
                            <input type="text" class="form-control" aria-describedby="surname" placeholder="Nazwisko">
                        </div>
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <input type="email" class="form-control" aria-describedby="email" placeholder="Email">
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn login-btn text-center"> Zarejestruj się</button>
                        </div>
